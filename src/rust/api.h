...
SEXP savvy_DataFusionRExprFunctions_and__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_approx_distinct__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_approx_percentile_cont__ffi(SEXP expr, SEXP percentile);
SEXP savvy_DataFusionRExprFunctions_approx_percentile_cont_with_weight__ffi(SEXP expr, SEXP weight_expr, SEXP percentile);
SEXP savvy_DataFusionRExprFunctions_array_agg__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_approx_median__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_avg__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_bitwise_and__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_bitwise_or__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_bitwise_shift_left__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_bitwise_shift_right__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_bitwise_xor__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_col__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_count__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_count_distinct__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_cube__ffi(SEXP args);
SEXP savvy_DataFusionRExprFunctions_ident__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_false__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_not_false__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_not_true__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_not_unknown__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_null__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_true__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_is_unknown__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_max__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_median__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_min__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_not__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_or__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExprFunctions_placeholder__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_rollup__ffi(SEXP args);
SEXP savvy_DataFusionRExprFunctions_stddev__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_sum__ffi(SEXP arg);
SEXP savvy_DataFusionRExprFunctions_lit__ffi(SEXP x);
SEXP savvy_DataFusionRExprFunctions_wildcard__ffi(void);
