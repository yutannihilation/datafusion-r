...
SEXP savvy_DataFusionRExpr_col__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_wildcard__ffi(void);
SEXP savvy_DataFusionRExpr_print__ffi(SEXP self__);
SEXP savvy_DataFusionRExpr_and__ffi(SEXP self__, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_and__ffi(SEXP self__, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_or__ffi(SEXP self__, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_shift_left__ffi(SEXP self__, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_shift_right__ffi(SEXP self__, SEXP right);
SEXP savvy_DataFusionRExpr_or__ffi(SEXP self__, SEXP right);
...
SEXP savvy_DataFusionRExpr_bitwise_xor__ffi(SEXP self__, SEXP right);
