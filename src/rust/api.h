...
SEXP savvy_DataFusionRExpr_and__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_and__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_or__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_shift_left__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_shift_right__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_bitwise_xor__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_ident__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_false__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_not_false__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_not_true__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_not_unknown__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_null__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_true__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_is_unknown__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_not__ffi(SEXP arg);
SEXP savvy_DataFusionRExpr_or__ffi(SEXP left, SEXP right);
SEXP savvy_DataFusionRExpr_placeholder__ffi(SEXP arg);
