...
test_that("function expressions", {
  ...
  # array
  expect_equal(e(array_append(col("foo"), lit(2))),                    "array_append(foo, Float64(2))")
  expect_equal(e(array_concat(col("foo"), col("bar"))),                "array_concat(foo, bar)")
  expect_equal(e(array_dims(col("foo"))),                              "array_dims(foo)")
  expect_equal(e(array_distinct(col("foo"))),                          "array_distinct(foo)")
  expect_equal(e(array_element(col("foo"), lit(2))),                   "array_element(foo, Float64(2))")
  expect_equal(e(array_empty(col("foo"))),                             "empty(foo)")
  expect_equal(e(array_except(col("foo"), col("bar"))),                "array_except(foo, bar)")
  expect_equal(e(array_has(col("foo"), col("bar"))),                   "array_has(foo, bar)")
  expect_equal(e(array_has_all(col("foo"), col("bar"))),               "array_has_all(foo, bar)")
  expect_equal(e(array_has_any(col("foo"), col("bar"))),               "array_has_any(foo, bar)")
  expect_equal(e(array_intersect(col("foo"), col("bar"))),             "array_intersect(foo, bar)")
  expect_equal(e(array_ndims(col("foo"))),                             "array_ndims(foo)")
  expect_equal(e(array_pop_back(col("foo"))),                          "array_pop_back(foo)")
  expect_equal(e(array_pop_front(col("foo"))),                         "array_pop_front(foo)")
  expect_equal(e(array_position(col("foo"), lit(2), lit(0L))),         "array_position(foo, Float64(2), Int32(0))")
  expect_equal(e(array_positions(col("foo"), lit(2))),                 "array_positions(foo, Float64(2))")
  expect_equal(e(array_prepend(col("foo"), lit(2))),                   "array_prepend(foo, Float64(2))")
  expect_equal(e(array_remove(col("foo"), lit(2))),                    "array_remove(foo, Float64(2))")
  expect_equal(e(array_remove_all(col("foo"), lit(2))),                "array_remove_all(foo, Float64(2))")
  expect_equal(e(array_remove_n(col("foo"), lit(2), lit(3L))),         "array_remove_n(foo, Float64(2), Int32(3))")
  expect_equal(e(array_repeat(col("foo"), lit(2L))),                   "array_repeat(foo, Int32(2))")
  expect_equal(e(array_replace(col("foo"), lit("a"), lit("A"))),       'array_replace(foo, Utf8("a"), Utf8("A"))')
  expect_equal(e(array_replace_all(col("foo"), lit("a"), lit("A"))),   'array_replace_all(foo, Utf8("a"), Utf8("A"))')
  expect_equal(e(array_replace_n(col("foo"), lit("a"), lit("A"), lit(3L))), 'array_replace_n(foo, Utf8("a"), Utf8("A"), Int32(3))')
  expect_equal(e(array_resize(col("foo"), lit(2), lit(3L))),           "array_resize(foo, Float64(2), Int32(3))")
  expect_equal(e(array_reverse(col("foo"))),                           "array_reverse(foo)")
  expect_equal(e(array_slice(col("foo"), lit(3L), lit(10L), lit(3L))), 'array_slice(foo, Int32(3), Int32(10), Int32(3))')
  expect_equal(e(array_sort(col("foo"), lit(TRUE), lit(FALSE))),       "array_sort(foo, Boolean(true), Boolean(false))")
  expect_equal(e(array_to_string(col("foo"), lit(","))),               'array_to_string(foo, Utf8(","))')
  expect_equal(e(array_union(col("foo"), col("bar"))),                 "array_union(foo, bar)")
  expect_equal(e(cardinality(col("foo"))),                             "cardinality(foo)")
  expect_equal(e(flatten(col("foo"))),                                 "flatten(foo)")
  expect_equal(e(gen_series(lit(3L), lit(10L), lit(3L))),              'generate_series(Int32(3), Int32(10), Int32(3))')
  expect_equal(e(make_array(lit(3L), lit(10L), lit(3L))),              'make_array(Int32(3), Int32(10), Int32(3))')
  expect_equal(e(range(lit(3L), lit(10L), lit(3L))),                   'range(Int32(3), Int32(10), Int32(3))')
  expect_equal(e(string_to_array(col("foo"), lit(","), lit("-"))),     'string_to_array(foo, Utf8(","), Utf8("-"))')
})
